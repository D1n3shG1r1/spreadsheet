...
include("scripts.php");
 ...
 if(!empty($companyData)){
    ...
    $addedDateTime = $companyData["addedDateTime"];
    $companyAddress1 = $companyData["companyAddress1"];
    $companyAddress2 = $companyData["companyAddress2"];
...
<script>
  ...
  function getCountryZones(){
    ...
    var tmpProvince = '<?php echo $province; ?>';
      ...
      callAjax(data, path, function(response){
        ...
        if(code == 100){
          $.each(resp, function(idx, vl){
              ...
              if(tmpProvince == provId){
                var selectAttr = 'selected="selected"';
              }else{
                var selectAttr = '';
              }

              provinceHtml += '<option '+selectAttr+' value="'+provId+'">'+provName+'</option>';
    ...
    <div class="row">
      <div class="col-6">
        <div class="mb-3">
          ...
          <div>
            <input class="form-control" type="text" placeholder="Company Name" id="companyName" name="companyName" required value="<?php echo $companyName; ?>"/>
          </div>
        </div>
        ...
        <div>
          <select class="form-select " aria-label="Default select example" id="country" name="country" onchange="getCountryZones();">
            ...
            foreach ($countries as $ctryKey => $ctryVal) {
                $selected = '';
                if($country == $ctryVal["id"]){
                  $selected = 'selected="selected"';
                }

                echo '<option '.$selected.' value="'.$ctryVal["id"].'">'.$ctryVal["name"].'</option>';
            }
            ?>
          </select>
        </div>
      ...
      <div class="mb-3">
        ...
        <div>
          <input class="form-control" type="text" placeholder="Address Line 1" id="companyAddress1" name="companyAddress1" value="<?php echo $companyAddress1; ?>"/>
        </div>
      </div>
      <div class="mb-3">
        <label for="staticEmail" class="form-label">Phone 1<em>&#x2a;</em></label>
        <div>
          <input class="form-control" type="text" placeholder="Phone 1" id="phone1" name="phone1" value="<?php echo $phone1; ?>"/>
        </div>
      </div>
      <div class="mb-3">
        <label for="staticEmail" class="form-label">Primary Email<em>&#x2a;</em></label>
        <div>
          <input class="form-control" type="text" placeholder="Primary Email" id="primaryEmail" name="primaryEmail" value="<?php echo $primaryEmail; ?>"/>
        </div>
      </div>
      <div class="mb-3">
        <label for="staticEmail" class="form-label">Industry</label>
        <div>
          <input class="form-control" type="text" placeholder="Industry" id="industry" name="industry" value="<?php echo $industry; ?>"/>
        </div>
      </div>
      <div class="mb-3">
        <label for="staticEmail" class="form-label">Revenue Model</label>
        <div>
          <input class="form-control" type="text" placeholder="Revenue Model" id="revenueModel" name="revenueModel" value="<?php echo $revenueModel; ?>"/>
        </div>
      </div>
      </div>
      <div class="col-6">
        ...
        <div>
          <select class="form-select" aria-label="Default select example" id="companyGroup" name="companyGroup">
              ...
              <?php foreach ($companyGroups as $tmpGrpKey => $tmpGrpNm) {
                $selected = '';
                if(strtolower($tmpGrpNm) == strtolower($companyGroup)){
                  $selected = 'selected="selected"';
                }

                echo '<option '.$selected.' value="'.$tmpGrpNm.'">'.ucfirst($tmpGrpNm).'</option>';
              }?>
          </select>
        </div>
      </div>
      <div class="mb-3">
        ...
        <div>
          <input class="form-control" type="text" placeholder="City" id="city" name="city" value="<?php echo $city; ?>"/>
        </div>
      </div>
      <div class="mb-3">
        <label for="staticEmail" class="form-label">Address Line 2<em>&#x2a;</em></label>
        <div>
          <input class="form-control" type="text" placeholder="Address Line 2" id="companyAddress2" name="companyAddress2" value="<?php echo $companyAddress2; ?>"/>
        </div>
      </div>
      <div class="mb-3">
        <label for="staticEmail" class="form-label">Phone 2<em>&#x2a;</em></label>
        <div>
          <input class="form-control" type="text" placeholder="Phone 2" id="phone2" name="phone2" value="<?php echo $phone2; ?>"/>
        </div>
      </div>
      <div class="mb-3">
        <label for="staticEmail" class="form-label">Secondary Email</label>
        <div>
          <input class="form-control" type="text" placeholder="Secondary Email" id="secondaryEmail" name="secondaryEmail" value="<?php echo $secondaryEmail; ?>"/>
        </div>
      </div>
      <div class="mb-3">
        <label for="staticEmail" class="form-label">Technology</label>
        <div>
          <input class="form-control" type="text" placeholder="Technology" id="technology" name="technology" value="<?php echo $technology; ?>"/>
        </div>
      </div>
    </div>
      </div>
